...
import com.david.spring7restmvc.services.BeerServiceImpl;
...
class BeerControllerTest {
    ...
    @Autowired // autowiring produces something with sensible defaults in/for spring
    ObjectMapper objectMapper;

    @MockitoBean // cria uma instancia mockada
